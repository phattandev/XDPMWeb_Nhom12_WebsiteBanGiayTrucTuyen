            ...
            <div class="relative z-10 lg:grid lg:grid-cols-2 lg:gap-8 items-center">
                <div class="mb-12 lg:mb-0">
                    ...
                    <div class="flex space-x-4">
                        <a href="{{ route('shoes.index') }}" class="bg-slate-900 text-white px-8 py-3 rounded-lg font-semibold hover:bg-orange-600 transition shadow-lg">Xem bộ sưu tập</a>
                        <a href="{{ route('contact') }}" class="border-2 border-slate-200 text-slate-700 px-8 py-3 rounded-lg font-semibold hover:bg-slate-50 transition">Liên hệ</a>
                    </div>
                </div>
                <div class="relative">
